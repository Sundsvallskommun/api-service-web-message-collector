...
public class MessageDTO {
	...
	@Schema(description = "If the message was outbound from a manager or inbound from a customer ", example = "Testorsson")
	private final String lastName;

	@Schema(description = "Email for the poster", example = "test@sundsvall.se")
	private final String email;

	@Schema(description = "If the message was outbound from a manager or inbound from a customer ", example = "177")
